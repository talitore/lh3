...
- [ ] Determine public access settings for S3 objects.
- [ ] Create IAM User with programmatic access.
- [ ] Attach the necessary S3 permissions policy to the IAM User.
- [ ] Configure environment variables (`S3_BUCKET_NAME`, `AWS_REGION`, `AWS_ACCESS_KEY_ID`, `AWS_SECRET_ACCESS_KEY`) in the Next.js application.
