...
RSpec.describe 'RSVPs', type: :request, inertia: true do
  let(:user) { create(:user) }
  let(:event) { create(:event, creator: user, run_number: '100', descriptor: 'Group Run', date: Date.today, time: '07:00', address: '100 Park Ave') }
