...
RSpec.describe 'Photos', type: :request, inertia: true do
  let(:user) { create(:user) }
  let(:event) { create(:event, creator: user, run_number: '200', descriptor: 'Photo Run', date: Date.today, time: '06:30', address: '200 Lane, City') }
