 ...
 *
 * The badge can be rendered as a `span` or as a custom component using the `asChild` prop. Supports style variants such as `default`, `secondary`, `destructive`, and `outline`.
 *
